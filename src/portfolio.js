  ...
  data: [
    {
      ...
      fileName: "SomeImg",
      skills: [
        `נוי אהרונסון, עו"ד ומגשרת, בעלת תואר ראשון במשפטים (המכללה למנהל), ותואר שני בניהול ויישוב סכסוכים ומשא ומתן (אוניברסיטת בר אילן).
מגשרת מוסמכת המתמחה בפתרון סכסוכים וקונפליקטים, ובפרט בתחום המשפחה.
מוסמכת מטעם האפוטרופוס הכללי לעריכה והפקדה של ייפוי כוח מתמשך.
חברה בוועדות הערר מטעם משרד המשפטים, ומשמשת כמרצה באקדמיה.
בעלת ניסיון מקצועי עשיר ורב-שנים בתחום המשפט האזרחי, מומחית בניהול משא ומתן ומיצוי זכויות.
        `
      ],
      softwareSkills: [
        {
...
const contactPageData = {
  contactSection: {
    title: "צרו קשר",
    profile_image_path: "noy_main-removebg-preview.png",
    description:
      "תאומי רובינשטיין, יצחק שדה 4  \nתל אביב יפו,  6777504 \nטל. 972-3-307-5000+ | פקס. 972-3-777-8444+",
  },
  blogSection: {
    title: "Blogs",
    subtitle:
